...
project "AstrophysicsDataViewer"
    ...
    files { "./%{prj.name}/src/**.cpp", "./%{prj.name}/include/**.h", "./%{prj.name}/assets/logo/**.png",
     "./%{prj.name}/assets/planets/**.png", "./%{prj.name}/assets/fonts/**.ttf", "./%{prj.name}/assets/profile_pictures/**.png" }
